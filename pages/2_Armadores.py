...
# Cargar los datos
path = r"./data/armadores/armadores.csv"
...
metricas = {
    ...
    "Errores de armado": "errores_armado",
    "Tiempo de descanso": "tiempo_descanso",
    "Satisfaccion en ambiente laboral": "Score satisfacción laboral",
...
if metricas[metrica] not in df.columns:
    st.error(f"La columna '{metricas[metrica]}' no existe en el DataFrame. Verifique el nombre de la columna.")
else:
